...
serve(async (req) => {
  ...
  try {
    ...
    let prompt = `Create a children's book illustration that matches the art style, color palette, and illustration technique of the provided character image. `;
    ...
    prompt += `Make it warm, inviting, and magical.`;
